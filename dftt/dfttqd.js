...
let body = process.env.dfttparams;
        ...
        return new Promise((resolve) => {
            ...
            $.post(url, async (err, resp, data) => {
                try {
                    ...
                    if (result.code == 0) {
                        $.log(`\n【🎉🎉🎉 恭喜您鸭 🎉🎉🎉】执行签到: 成功 , 获得积分${result.data.bonus}`)
                        // await $.wait(3 * 1000)
                    } else {
